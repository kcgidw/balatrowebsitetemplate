let jokers = [
	...
	{
		name: 'Robo-Joker',
		text: ['Steel cards trigger when scored'],
		image_url: 'img/robo.png',
		rarity: 'Uncommon',
	},
	{
		name: 'Swiss Joker',
		text: ['X0.5 Mult for each unscored card this round'],
	...
	{
		name: 'Sock',
		text: ['X3 Mult on second hand of round'],
		image_url: 'img/sock.png',
		rarity: 'Uncommon',
	},
	{
		name: 'Power Grid',
		text: ['Mult and Steel cards count as each other'],
